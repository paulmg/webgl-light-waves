...
function guiPostProcess(gui) {
  var folder = gui.addFolder('Post Process');
...
function guiWaves(gui, waveGroup) {
  var folder = gui.addFolder('Waves');
...
function guiWave(gui, wave) {
  var folder = gui.addFolder('Wave');
